  ...
  <section id="home" class="mt-100">
    <div class="container">
      <div class="home-banner position-relative mb-30 br-10 overflow-hidden">
        <img src="{{ url('assets/images/homepage/banner.png') }}" alt="" class="wp-100">
        <div class="position-absolute hb-caption d-flex flex-column justify-content-center ps-35 pe-35 text-light">
          ...
          <div class="hbc-input-search d-flex align-items-center ps-30 pe-30 br-20 mt-24">
            <input type="text" class="border-0 bg-transparent text-light fs-18" placeholder="Search, other places, event or tickets...">
          ...
          <div class="hbc-tags mt-20 fs-18">
            <a class="text-light text-decoration-none me-10" href="#">#coldplay</a>
            <a class="text-light text-decoration-none me-10" href="#">#jisphoria</a>
            <a class="text-light text-decoration-none me-10" href="#">#ticketfree</a>
            <a class="text-light text-decoration-none me-10" href="#">#music</a>
            <a class="text-light text-decoration-none me-10" href="#">#jatimpark</a>
          </div>
        </div>
      </div>
      ...
      <div class="home-best-deals pb-50 overflow-hidden">
        <div class="d-flex justify-content-between align-items-start mb-30">
          <h1 class="fs-30 fw-700 text-light">Best Deals</h1>
          <a href="#" class="fs-20 fw-500 text-light text-decoration-none">See All</a>
        </div>
        <div class="swiper-hbd position-relative">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <a href="#" class="hbd-item text-decoration-none d-block br-10 overflow-hidden">
                <img src="{{ url('assets/images/best-deals/1.png') }}" alt="" class="wp-100">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="hbd-item text-decoration-none d-block br-10 overflow-hidden">
                <img src="{{ url('assets/images/best-deals/2.png') }}" alt="" class="wp-100">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="hbd-item text-decoration-none d-block br-10 overflow-hidden">
                <img src="{{ url('assets/images/best-deals/3.png') }}" alt="" class="wp-100">
              </a>
            </div>
            <div class="swiper-slide">
              <a href="#" class="hbd-item text-decoration-none d-block br-10 overflow-hidden">
      ...
      <div class="home-popular pb-20">
        <div class="d-flex justify-content-between align-items-start mb-30">
          <h1 class="fs-30 fw-700 text-light">Popular at Tiketbox.com</h1>
          <a href="#" class="fs-20 fw-500 text-light text-decoration-none">See All</a>
        </div>
        <div class="row">
          <a :href="`/event/${popular.id}`" class="col-4" v-for="(popular,index) in popular" :key="index">
            <div class="hp-item position-relative mb-30 br-10 overflow-hidden">
              ...
              <div class="p-10">
                <h5 class="fs-16 fw-700 text-light" v-text="`${popular.name} - ${popular.location_name}`"></h5>
      ...
      <div class="home-place-best-deals overflow-hidden">
        <div class="d-flex justify-content-between align-items-start mb-30">
          <h1 class="fs-30 fw-700 text-light">Places with Best Deals</h1>
          <a href="#" class="fs-20 fw-500 text-light text-decoration-none">See All</a>
        </div>
              ...
              <div class="hpbd-item br-10 overflow-hidden position-relative">
                ...
                <div class="p-10">
                  ...
                  <div class="d-flex align-items-end justify-content-between">
                    ...
                    <a class="btn btn-primary fs-14 fw-500 px-30 py-5 br-100">Buy Now</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="home-upcoming">
        <div class="d-flex justify-content-between align-items-start mb-30">
          <h1 class="fs-30 fw-700 text-light">Upcoming Events</h1>
          <a href="#" class="fs-20 fw-500 text-light text-decoration-none">See All</a>
        </div>
      </div>
      <div class="home-past-events">
        <div class="d-flex justify-content-between align-items-start mb-30">
          <h1 class="fs-30 fw-700 text-light">Past Events</h1>
          <a href="#" class="fs-20 fw-500 text-light text-decoration-none">See All</a>
        </div>
        <div class="row">
          <div class="col-4">
