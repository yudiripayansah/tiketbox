...
@section('screen')
  <section id="bDashboard" class="br-tl-10 br-tr-10 overflow-hidden backoffice">
      ...
      <div class="boc-content bg-transparent">
        <div class="d-flex p-25 br-15 align-items-center justify-content-center mt-25" style="background: rgba(193, 193, 193, 0.40);backdrop-filter: blur(20.067087173461914px);">
          ...
          <a href="/promotor/legal-information" class="btn btn-primary btn-sm">Click Here</a>
        </div>
        <div class="row mt-25" v-if="users.type != 'user'">
