...
@section('screen')
  <section id="bcategory" class="br-tl-10 br-tr-10 overflow-hidden backoffice">
          ...
          <table class="table table-bordered table-stripped table-dark table-sm">
            <thead>
              <tr>
                ...
                <th class="text-center wp-15">Parent</th>
              ...
              <tr v-else v-for="(d,index) in list.data" :key="index">
                ...
                <td class="align-top" v-text="d.parent"></td>
                <td class="align-top" v-text="d.name"></td>
                <td class="align-top" v-text="d.description"></td>
