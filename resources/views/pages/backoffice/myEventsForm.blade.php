              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <input type="date" class="flatpickr bg-transparent border-0 text-light fs-16 fw-700 ms-10" v-model="form.data.date_start">                    
                  </div>
                </div>
                <div class="col-6">
              ...
              <div class="row">
                <div class="col-3">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <input type="date" class="flatpickr bg-transparent border-0 text-light fs-16 fw-700 ms-10" v-model="ticket_paid.date_start">                    
                  </div>
                </div>
                <div class="col-3">
                  <label class="fs-14 fw-400 text-light mb-10">Tanggal Berakhir</label>
                  <div class="d-flex align-items-center">
                    ...
                    <input type="date" class="flatpickr bg-transparent border-0 text-light fs-16 fw-700 ms-10" v-model="ticket_paid.date_end">                    
                  </div>
                </div>
                <div class="col-3">
                  <label class="fs-14 fw-400 text-light mb-10">Waktu Mulai</label>
              ...
              <div class="row">
                <div class="col-3">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <input type="date" class="flatpickr bg-transparent border-0 text-light fs-16 fw-700 ms-10" v-model="ticket_free.date_start">                    
                  </div>
                </div>
                <div class="col-3">
                  <label class="fs-14 fw-400 text-light mb-10">Tanggal Berakhir</label>
                  <div class="d-flex align-items-center">
                    ...
                    <input type="date" class="flatpickr bg-transparent border-0 text-light fs-16 fw-700 ms-10" v-model="ticket_free.date_end">                    
                  </div>
                </div>
                <div class="col-3">
                  <label class="fs-14 fw-400 text-light mb-10">Waktu Mulai</label>
