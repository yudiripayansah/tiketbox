...
<html lang="en-US">
  ...
  <body>
    <table cellpadding="0" cellspacing="0" class="box-email ms-auto me-auto my-50 overflow-hidden br-tl-10 br-tr-10" style="background-color: #252525;border-top-left-radius: 10px;border-top-right-radius:10px;overflow:hidden;">
      <tr>
        <td class="heading-email d-flex align-items-center justify-content-between p-20 bg-primary" style="background-color: #0D6EFD;padding: 20px;">
          <table  width="100%">
            <tr>
              <td width="30%">
                <img src="{{ url('assets/images/auth/ticketboxlogo.png') }}" alt="">
              </td>
              <td class="text-light" width="70%" style="text-align: right;">
                <h1 class="fs-20 fw-700 text-light" style="color:white;font-size:20px;font-weight:700;margin:0;padding:0;">Ticket Dunia Fantasi (Dufan) Ancol</h1>
                <h6 class="fs-12 fw-700" style="color:white;font-size:12px;font-weight:700;margin:0;padding:0;">Powered By : PT Pembangunan Jaya Ancol .Tbk</h6>
              </td>
            </tr>
          </table>
        </td>
            ...
            <tr>
              <td class="left wp-60 text-light" width="60%">
                <p class="d-flex align-items-center fs-12 fw-400" style="color:white;font-size:12px;font-weight:400;">
                  ...
                  Jalan Lodan Timur No.7, RW.10, Ancol, Kec. Pademangan, City Jakarta Utara, Daerah Khusus Ibucity Jakarta 14430
                </p>
                <p class="d-flex align-items-center fs-12 fw-400" style="color:white;font-size:12px;font-weight:400;">
                  ...
                  06 November 2023 <span class="ms-25" style="margin-left:25px;">Ticket Berlaku hingga : 09 November 2023</span>
                </p>
                <p class="d-flex align-items-center fs-12 fw-400" style="color:white;font-size:12px;font-weight:400;">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-20 h-20 me-10">
                    <g id="bxs:time">
              ...
              <td class="right wp-30" width="30%">
                <img src="{{ url('assets/images/place-deals/1.png') }}" alt="" class="wp-100 br-10">
              </td>
            </tr>
          </table>
        </td>
            ...
            <tr>
              <td class="left wp-80 pe-25 text-light" width="80%" style="padding-right:25px;">
                  ...
                  <tr>
                    <td width="33%" style="padding-right: 15px;border-right:1px solid grey;" class="col border-end border-secondary">
                      ...
                      <div>
                        ...
                        <span class="fs-12 fw-600" style="color:white;font-size:12px;font-weight:700;">{{ date('d F Y',strtotime($dEmail->orders->created_at)) }}</span>
                      </div>
                    </td>
                    <td width="33%" style="padding-right: 15px;padding-left:15px;border-right:1px solid grey;" class="col border-end border-secondary">
                      <div class="mb-10" style="margin-bottom: 10px;">
                        ...
                        <span class="fs-12 fw-600" style="color:white;font-size:12px;font-weight:700;">Ticket Login Orang</span>
                      </div>
                      <div>
                        ...
                        <span class="fs-12 fw-600" style="color:white;font-size:12px;font-weight:700;">151299354</span>
                      </div>
                    </td>
                    <td width="33%" style="padding-right: 15px;padding-left:15px;border-right:1px solid grey;" class="col">
                      <div class="mb-10" style="margin-bottom: 10px;">
                        ...
                        <span class="fs-12 fw-600" style="color:white;font-size:12px;font-weight:700;">-</span>
                      </div>
                      <div>
                ...
                <div class="p-15 br-10" style="background-color:rgba(193, 193, 193, 0.40);padding:15px;border-radius:10px;">
                  <ul class="m-0 p-0 list-unstyled" style="color:white;font-size:12px;font-weight:400;list-style:none;margin:0;padding:0">
                    <li>- Berlaku untuk Ticket Login Ancol</li>
                    <li>- Berlaku untuk ticket terusan all wahana ( 10 wahana )</li>
                    <li>- Hanya berlaku untuk 1x login pada tanggal kedatangan yang dipilih</li>
                  </ul>
                </div>
              </td>
              <td class="right wp-20 text-light" width="20%">
                ...
                {{-- <img src="{{ QrCode::size(150)->format('png')->generate('TXB-54476897') }}" alt=""> --}}
              </td>
            </tr>
          </table>
        </td>
        ...
        <td class="order-toc p-20 text-light" style="padding: 20px;">
          ...
          <div class="fs-12 fw-400" style="color:white;font-size:12px;font-weight:400;">
            ...
            <ul class="list-unstyled" style="list-style: none;margin:0;padding:0;">
              <li>1. Ticket berlaku untuk 1 orang dan 1x login sesuai dengan tanggal yang tercetak di e-ticket</li>
              <li>2. Ticket yang sudah dibeli tidak dapat dibackkan / direfund</li>
              <li>3. Kami tidak bertanggung jawab atas kehilangan e-ticket ini</li>
              <li>4. Dilarang membawa senjata tajam atau obat-obatan terlarang</li>
              <li>5. Penyelenggara berhak untuk tidak memberikan izin login ke dalam arena concert apabila syarat dan ketentuan tidak terpenuhi</li>
            </ul>
          </div>
        </td>
      </tr>
